...
public class FolioSearchActivityHolder {
    ...
    public static void setInitMobileAdsTimes(Integer initMobileAdsTimes) {
        FolioSearchActivityHolder.initMobileAdsTimes = initMobileAdsTimes;
    }
    ...
    public static void setRequestTimes(Integer requestTimes) {
        FolioSearchActivityHolder.requestTimes = requestTimes;
    }

    public static AdView getAdView() {
        return FolioSearchActivityHolder.adView;
    }
    ...
    public static void setAdRequest(AdRequest adRequest) {
        FolioSearchActivityHolder.adRequest = adRequest;
    ...
    public static void setAdView(AdView adView) {
        FolioSearchActivityHolder.adView = adView;
        FolioSearchActivityHolder.viewTimes += 1;
        String LOG_TAG = "[folio][admob]";
    ...
    public static void setTestDeviceList(List<String> testDeviceList) {
        FolioSearchActivityHolder.testDeviceList = testDeviceList;
    }
    ...
    public static void setAdmobUnitId(String admobUnitId) {
        FolioSearchActivityHolder.admobUnitId = admobUnitId;
    }
    ...
    public static void setAdmobApplicationId(String admobApplicationId) {
        FolioSearchActivityHolder.admobApplicationId = admobApplicationId;
    }

    public FolioSearchActivityHolder(Context context, Activity activity, ConstraintLayout layout) {
    ...
    public void forceLoadAd(AdView adView, AdRequest adRequest) {
        ...
        FolioSearchActivityHolder.requestTimes += 1;
    ...
    public void initAdmob() {
        ...
        MobileAds.initialize(context, new OnInitializationCompleteListener() {
            ...
            public void onInitializationComplete(InitializationStatus initializationStatus) {
                FolioSearchActivityHolder.initMobileAdsTimes += 1;
